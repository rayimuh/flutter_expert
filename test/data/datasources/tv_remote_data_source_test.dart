...
void main() {
  const API_KEY = 'api_key=c86633d77e7146fc3abb7a3aa3522b81';
  ...
  group('search tv', () {
    final tSearchResult = TvResponse.fromJson(
            json.decode(readJson('dummy_data/search_farma_tv.json')))
        .tvList;
    final tQuery = 'Farma';
    ...
    test('should return list of movies when response code is 200', () async {
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/search_farma_tv.json'), 200));
      // act
