...
import 'package:ditonton/presentation/provider/playing_movies_notifier.dart';
...
class _PlayingMoviesPageState extends State<PlayingMoviesPage> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() =>
        Provider.of<PlayingMoviesNotifier>(context, listen: false)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Consumer<PlayingMoviesNotifier>(
